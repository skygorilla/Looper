// Content script - Inject actual LooperAutopilotAdvanced component
(function() {
  'use strict';
  ...
  // Inject the actual LooperAutopilotAdvanced HTML structure
    ...
    <div style="position: relative; width: 100%; height: 100%; pointer-events: none;">
      ...
      ">
        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
          <div class="looper-tab" onclick="toggleDevTools()" style="
            width: 56px;
            height: 56px;
            border-radius: 50%;
        ...
        ">
          ...
          <!-- Inject Button -->
          <button onclick="injectPrompt()" style="
            width: 100%;
            height: 56px;
            border-radius: 16px;
            background: linear-gradient(135deg, #1F2328 0%, #1A1C1F 100%);
